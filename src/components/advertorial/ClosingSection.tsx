    ...
    <section className="py-5 md:py-6 border-t border-border/30">
      ...
      <div className="mb-6">
        <p className="text-base md:text-lg leading-normal text-foreground/90 mb-2">
          Si llevas tiempo sintiendo que algo no está bien, aunque los estudios médicos digan lo contrario,{" "}
          <strong className="font-semibold text-foreground">no estás equivocada</strong>.
        </p>
      ...
      <div className="bg-gradient-to-br from-primary via-primary to-secondary/80 rounded-lg p-4 md:p-8 text-center shadow-card">
        <a
          ...
          onClick={() => {
            if (typeof window !== 'undefined' && (window as any).fbq) {
              (window as any).fbq('trackCustom', 'Click_Start_Test');
            }
          }}
        ...
        <p className="text-primary-foreground/90 text-sm md:text-base leading-normal max-w-lg mx-auto">
          Este test está basado en modelos de Porges, Levine y evidencia actual en regulación autonómica. Te tomará
          menos de 2 minutos.
        </p>
      </div>
    </section>
