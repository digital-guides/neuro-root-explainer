...
// Advertorial 2 - PENDIENTE: Actualizar con tu contenido
export const advertorial2: AdvertorialContent = {
  ...
  hero: {
    ...
    heroImage: "/assets/hero-image.jpg", // Cambiar por tu imagen
  ...
  scientific: {
    ...
    nervousSystemImage: "/assets/nervous-system-image.jpg", // Cambiar por tu imagen
